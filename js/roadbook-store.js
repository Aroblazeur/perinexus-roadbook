...
function normalizeDay(day, index, ids) {
  ...
  return Object.freeze({
    ...
    kilometers: asNumber(day.kilometers ?? day.distanceKm),
    elevationGain: asNumber(day.elevationGain ?? day.elevationGainM),
    ...
    description: asText(day.description ?? day.summary),
    gpx: asText(day.gpx ?? day.route?.gpx),
    photos: freezeArray(day.photos),
    interest: freezeArray(day.interest ?? day.pois),
